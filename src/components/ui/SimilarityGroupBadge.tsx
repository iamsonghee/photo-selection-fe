...
export function SimilarityGroupBadge({ count, expanded, selectedCount = 0, label, onClick, inline = false }: {
  count: number; expanded: boolean; selectedCount?: number; label?: string;
