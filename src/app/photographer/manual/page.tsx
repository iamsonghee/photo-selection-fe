        ...
        <main className="flex-1 min-w-0 space-y-12">
          ...
          <section className={cardCls}>
            <div className="p-6 md:p-8">
              ...
              <Steps items={[
                "셀렉 갯수(N장) 이상 업로드가 완료되면 업로드 페이지 하단에 <strong>고객 초대 링크 활성화</strong> 버튼이 활성화됩니다.",
          ...
          <section className={cardCls}>
            <div className="p-6 md:p-8">
              ...
              <Steps items={[
                ...
                "장수 조건을 충족하면 하단 <strong>보정 의뢰하기</strong> 버튼이 활성화됩니다.",
                "<strong>확정 및 전송</strong>을 누르면 작가에게 셀렉 결과가 전달됩니다.",
              ]} />
              <Tip>
                확정 후 작가가 보정을 시작하기 전이라면 고객이 최대 3회까지 확정을 취소하고 다시 선택할 수 있습니다.
              </Tip>
            </div>
          </section>
          ...
          <section className={cardCls}>
            <div className="p-6 md:p-8">
              ...
              <Steps items={[
                ...
                "이상이 없으면 <strong>작가에게 전달</strong> 버튼을 누릅니다.",
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mt-4">
                ...
                <FaqItem
                  ...
                  a="작가가 보정을 시작하기 전이라면 고객이 확정 화면에서 직접 취소할 수 있습니다 (최대 3회). 보정이 이미 시작됐거나 3회를 초과한 경우에는 작가에게 직접 연락해야 합니다."
                />
                <FaqItem
