...
function Clock() {
  ...
  return <span className="landing-mono text-[10px] text-foreground">{time}</span>;
}
    ...
    <>
      <header className="fixed landing-header-left z-50 hidden lg:flex items-center gap-6 lg:gap-12">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-accent flex items-center justify-center text-black font-black text-xs">A</div>
          <span className="landing-display font-bold tracking-tighter text-2xl uppercase">
            A-Cut<span className="text-accent">.</span>
          </span>
        </div>
      ...
      <div className="fixed landing-header-right z-50 hidden lg:flex items-center gap-4">
        <span className="landing-mono text-[10px] text-subtle-foreground">SYS_TIME</span>
        <Clock />
      </div>
    </>
  );
    ...
    <section className="relative z-10 w-full min-h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center lg:pr-12 max-w-xl">
        <div className="mb-6 flex items-center gap-3">
          <span className="landing-mono text-[10px] tracking-[0.2em] text-accent border border-accent/30 px-2 py-1">
        ...
        <h1 className="landing-display text-4xl sm:text-5xl lg:text-7xl font-black leading-[1.1] mb-8 uppercase landing-break">
          사진 셀렉, 이제<br />
          <span className="text-accent landing-glitch">링크 하나</span>로<br />
          끝냅니다.
        </h1>

        <div className="space-y-6 mb-12 border-l-2 border-border-subtle pl-8">
          ...
          <p className="text-xl leading-relaxed text-muted-foreground max-w-lg landing-break">
            A컷은 그 모든 걸 하나의 링크로 대체합니다.<br />
            <span className="text-foreground font-bold">작가는 업로드만, 고객은 클릭만.</span>
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 items-start">
          ...
          <div className="flex items-center gap-3 text-[12px] landing-mono text-subtle-foreground">
            ...
            <span className="flex items-center gap-1">
              <div className="w-1 h-1 bg-accent" /> 신용카드 불필요
            </span>
          </div>
          <Link
            href="/guide"
            className="text-[13px] text-subtle-foreground hover:text-muted-foreground transition-colors"
      ...
      <div className="landing-hero-mockup flex-1 relative w-full h-full flex items-center justify-center">
        <div className="relative w-full max-w-[500px] border border-border-subtle bg-background shadow-2xl p-6">
          {/* Mockup header bar */}
          <div className="flex justify-between items-center mb-6 landing-mono text-[10px] text-subtle-foreground tracking-widest border-b border-border-subtle pb-4">
            <div className="flex items-center gap-2">
          ...
          <div className="relative grid grid-cols-2 gap-3">
            {PHOTOS.map((p, i) => (
              <div key={i} className={`landing-photo-card${active[i] ? " is-active" : ""}`}>
                ...
                <div
                  className={`absolute bottom-2 left-2 landing-mono text-[8px] bg-black/50 px-1 ${active[i] ? "text-accent" : "text-muted-foreground"}`}
                >
                  {p.filename}
                </div>
          ...
          <div className="mt-6 flex items-center justify-between landing-mono text-[9px]">
            <div className="flex items-center gap-2">
              <span className="text-subtle-foreground">SYNC_STATUS</span>
              <div className="w-32 h-1 bg-border-subtle">
                <div
            ...
            <span className="text-accent">REAL_TIME_SYNCING...</span>
          </div>
          ...
          <div className="landing-stats-panel absolute -bottom-16 -right-16 w-60 z-20">
            ...
            <div>TIME_SAVED: <span className="text-accent">94.8%</span></div>
            <div>ERROR_RATE: <span className="text-accent">0.00%</span></div>
            <div>PROCESS: <span className="text-accent">AUTO_MATCH</span></div>
            <div>LATENCY: <span className="text-accent">14MS</span></div>
          </div>
        </div>

        {/* Background watermark */}
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 landing-display font-black text-foreground/[0.02] pointer-events-none select-none -z-10 uppercase"
...
function MobileHeroSection({ onAuthOpen, isLoggedIn }: { onAuthOpen: () => void; isLoggedIn: boolean }) {
  ...
  return (
    <div className="relative z-10">
      ...
      >
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 bg-accent flex items-center justify-center text-black font-black text-[10px]">A</div>
          <span className="landing-display font-bold tracking-tighter text-lg uppercase">
            A-Cut<span className="text-accent">.</span>
          </span>
        </div>
        <div className="flex flex-col items-end gap-0.5">
          <span className="landing-mono text-[8px] text-subtle-foreground leading-none">SYS_TIME</span>
          <Clock />
        </div>
      </header>
      ...
      <div className="w-full px-6 pt-2 pb-20" style={{ display: "flex", flexDirection: "column", gap: "48px" }}>
        ...
        <div className="flex flex-col">
          <div className="mb-4">
            <span className="landing-mono text-[8px] tracking-[0.2em] text-accent border border-accent/30 px-1.5 py-0.5">
              ACTIVE_PROTOCOL_V1.0.2
            </span>
          </div>
          ...
          <div className="space-y-4 mb-8 border-l border-border-subtle pl-4">
            <p className="landing-strikethrough text-sm leading-relaxed text-muted-foreground landing-break">
              구글드라이브 링크 보내고, 고객 답장 기다리고, 파일명 대조하는 번거로운 과정.
            </p>
            <p className="text-base leading-relaxed text-muted-foreground font-medium landing-break">
              작가는 업로드만, 고객은 클릭만.<br />
          ...
          <div className="flex items-center gap-4 text-[9px] landing-mono text-subtle-foreground justify-center">
            ...
            <span className="flex items-center gap-1">
              <div className="w-1 h-1 bg-accent" /> NO CREDIT CARD
            </span>
          </div>
          <Link
            href="/guide"
            className="text-[12px] text-subtle-foreground hover:text-muted-foreground transition-colors text-center block mt-1"
            style={{ textDecoration: "underline", textUnderlineOffset: 3 }}
          >
            처음 쓰신다면 → 사용 가이드 먼저 보기
          </Link>
        ...
        <div className="relative w-full">
          {/* Mockup box */}
          <div className="relative w-full border border-border-subtle bg-background shadow-2xl p-4">
            <div className="flex justify-between items-center mb-4 landing-mono text-[8px] text-subtle-foreground tracking-wider border-b border-border-subtle pb-3">
              <div className="flex items-center gap-2">
            ...
            <div className="relative grid grid-cols-2 gap-2">
              {PHOTOS.map((p, i) => (
                <div key={i} className={`landing-photo-card${active[i] ? " is-active" : ""}`}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={p.src} alt={`Portrait ${i + 1}`} />
                  <div className={`absolute bottom-1.5 left-1.5 landing-mono text-[6px] bg-black/50 px-1 ${active[i] ? "text-accent" : "text-muted-foreground"}`}>
                    {p.filename}
                  </div>
                  <div className="landing-selection-badge">A-CUT</div>
                </div>
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between landing-mono text-[7px]">
                <span className="text-subtle-foreground">SYNC_STATUS</span>
                <span className="text-accent animate-pulse">REAL_TIME_ACTIVE</span>
              </div>
              <div className="w-full h-[1px] bg-border-subtle">
                <div className="h-full bg-accent transition-all duration-700" style={{ width: sync }} />
              </div>
            </div>
          </div>
          ...
          <div className="landing-stats-panel mt-4 w-full">
            <div className="flex justify-between">
              <span className="text-foreground">_OPTIMIZATION_REPORT</span>
              <span>V.1.0</span>
            </div>
  ...
  return (
    <section className="relative z-10 w-full" style={{ background: "var(--background)" }}>
      ...
      <div className="h-screen flex flex-col items-center justify-center text-center px-5 sm:px-8 lg:px-24">
        <Reveal>
          <div className="landing-mono text-[10px] tracking-[0.2em] text-accent mb-6 uppercase">
          ...
          <h2 className="landing-display text-3xl sm:text-5xl lg:text-7xl font-black uppercase leading-tight mb-8 landing-break">
            혹시 지금 이렇게<br />
            <span className="text-accent">하고 계신가요?</span>
          </h2>
          <div className="h-16 w-[1px] bg-accent mt-12 mx-auto" />
        </Reveal>
      </div>
        ...
        <div key={i}>
          ...
          >
            ...
            <Reveal className="text-center max-w-4xl mx-auto w-full">
              <div className="landing-mono text-[10px] tracking-[0.2em] text-accent uppercase mb-12">
                {p.code}
              </div>
              <blockquote className="text-base sm:text-xl lg:text-3xl font-light italic text-muted-foreground mb-10 sm:mb-16 leading-relaxed landing-break whitespace-pre-line">
                {p.quote}
              </blockquote>
              <div className="space-y-6 text-sm sm:text-lg text-muted-foreground">
                <p className="landing-break whitespace-pre-line">{p.body}</p>
                {p.emphasis && (
                  <p className="text-foreground font-bold text-base sm:text-xl landing-break">{p.emphasis}</p>
                )}
                {!p.emphasis && i === 1 && (
                  <p className="text-subtle-foreground italic landing-break">
      ...
      {/* CTA transition */}
      <div className="py-24 sm:py-48 flex flex-col items-center justify-center text-center bg-background">
        <Reveal>
          <p className="landing-mono text-xs text-subtle-foreground uppercase tracking-[0.3em] mb-4">
...
function ServicesSection() {
  return (
    <section id="services" className="relative z-10 w-full py-24 bg-background" style={{ minHeight: "100vh" }}>
      {/* Grid overlay */}
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 sm:px-12 flex flex-col h-full">
        {/* Header */}
        <div className="mb-10 sm:mb-16 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 border-b border-border-subtle pb-6 sm:pb-8">
          <div className="landing-jb text-[10px] text-subtle-foreground uppercase flex flex-col gap-1">
            <span className="before:content-['>'] before:text-accent before:mr-2">OP_MODE: SOLUTIONS</span>
            <span className="before:content-['>'] before:text-accent before:mr-2">STATUS: HIGH_EFFICIENCY</span>
            <span className="before:content-['>'] before:text-accent before:mr-2">DATA_STREAM: ACTIVE</span>
          </div>
          <h2 className="landing-display text-3xl sm:text-4xl lg:text-5xl font-bold uppercase leading-[1.1] sm:text-right">
            A컷이 바꾸는<br /><span className="text-accent">3가지</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Reveal delayMs={0}>
            <article className="landing-panel">
              <div className="flex justify-between items-center px-5 py-4 border-b border-border-subtle landing-jb text-xs font-bold">
                <span className="landing-panel-num">01</span>
                <span className="text-subtle-foreground tracking-[0.05em]">SYS.LINK.GEN</span>
              </div>
              <div className="relative overflow-hidden bg-black" style={{ height: 240 }}>
                <svg className="w-full h-full" viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">
                  <rect x="60" y="40" width="80" height="60" fill="var(--border-subtle)" />
                  <rect x="160" y="40" width="80" height="60" fill="var(--border-subtle)" />
                  <rect x="260" y="40" width="80" height="60" fill="var(--border-subtle)" />
                  <rect x="60" y="120" width="80" height="60" fill="var(--border-subtle)" />
                  <rect x="160" y="120" width="80" height="60" fill="var(--border-subtle)" />
                  <rect x="260" y="120" width="80" height="60" fill="var(--border-subtle)" />
                  <circle cx="130" cy="90" r="8" fill="var(--accent)" />
                  <polyline points="126,90 129,93 134,87" stroke="#fff" fill="none" strokeWidth="1.5" />
                  <circle cx="230" cy="90" r="8" fill="var(--accent)" />
                  <polyline points="226,90 229,93 234,87" stroke="#fff" fill="none" strokeWidth="1.5" />
                  <circle cx="230" cy="170" r="8" fill="var(--accent)" />
                  <polyline points="226,170 229,173 234,167" stroke="#fff" fill="none" strokeWidth="1.5" />
                  <text x="60" y="30" fontFamily="'JetBrains Mono', monospace" fontSize="9" fill="var(--subtle-foreground)" textDecoration="uppercase">Select Mode: Active</text>
                  <rect x="60" y="200" width="280" height="1" fill="var(--border-strong)" />
                </svg>
              </div>
              <div className="p-6 flex flex-col flex-1">
                <h3 className="landing-display text-lg font-bold mb-3">링크 하나로 셀렉 완료</h3>
                <p className="text-subtle-foreground text-sm leading-relaxed mb-6 flex-1 landing-break">
                  작가가 사진을 업로드하면 고객 전용 갤러리 링크가 생성됩니다. 고객은 마음에 드는 사진을 직접 클릭해서 선택합니다.
                </p>
                <div className="landing-effect-block">
                  <div className="flex flex-col mb-3 pb-3 border-b border-dashed border-border-subtle">
                    <span className="landing-jb text-[10px] text-subtle-foreground uppercase mb-1">TIME_REDUCTION</span>
                    <span className="landing-display text-2xl text-accent font-bold">87% 단축</span>
                  </div>
                  <div className="landing-jb text-[11px] flex items-center gap-2">
                    <span className="text-subtle-foreground line-through">카톡 5회</span>
                    <span className="text-accent">→</span>
                    <span className="text-foreground font-bold">링크 1개</span>
                  </div>
                </div>
              </div>
            </article>
          ...
          <Reveal delayMs={80}>
            <article className="landing-panel">
              <div className="flex justify-between items-center px-5 py-4 border-b border-border-subtle landing-jb text-xs font-bold">
                ...
                <span className="text-subtle-foreground tracking-[0.05em]">DATA.COMPARE</span>
              </div>
              <div className="relative overflow-hidden bg-black" style={{ height: 240 }}>
                {/* Before/after split */}
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute top-3 w-full flex justify-between px-4 z-10 landing-jb text-[9px] uppercase" style={{ textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>
                    <span className="text-foreground">BEFORE [RAW]</span>
                    <span className="text-accent font-bold">AFTER [PROC]</span>
                  </div>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                  ...
                  />
                  {/* Split line */}
                  <div className="absolute top-0 left-1/2 w-[1px] h-full bg-accent z-[5]" />
                  {/* Scan sweep */}
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="landing-effect-block">
                  <div className="flex flex-col mb-3 pb-3 border-b border-dashed border-border-subtle">
                    <span className="landing-jb text-[10px] text-subtle-foreground uppercase mb-1">REVISION_CYCLE</span>
                    <span className="landing-display text-2xl text-accent font-bold">평균 1.4회</span>
                  </div>
                  <div className="landing-jb text-[11px] flex items-center gap-2">
                    <span className="text-subtle-foreground line-through">텍스트 설명</span>
                    <span className="text-accent">→</span>
                    <span className="text-foreground font-bold">직접 지정 코멘트</span>
                  </div>
                </div>
              </div>
            </article>
          ...
          <Reveal delayMs={160}>
            <article className="landing-panel">
              <div className="flex justify-between items-center px-5 py-4 border-b border-border-subtle landing-jb text-xs font-bold">
                ...
                <span className="text-subtle-foreground tracking-[0.05em]">SYNC.MOBILE</span>
              </div>
              <div className="relative overflow-hidden bg-black" style={{ height: 240 }}>
                <svg className="w-full h-full" viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">
                  <rect x="160" y="30" width="80" height="160" rx="12" stroke="var(--foreground)" fill="none" strokeWidth="1.2" />
                  <rect x="190" y="38" width="20" height="4" rx="2" stroke="var(--border-strong)" fill="none" strokeWidth="1" />
                  <rect x="168" y="50" width="30" height="30" fill="var(--border-subtle)" />
                  <rect x="202" y="50" width="30" height="30" fill="var(--border-subtle)" />
                  <rect x="168" y="84" width="30" height="30" fill="var(--border-subtle)" />
                  <rect x="202" y="84" width="30" height="30" fill="var(--border-subtle)" />
                  <rect x="168" y="130" width="64" height="4" rx="2" fill="var(--border-subtle)" />
                  <rect x="168" y="130" width="45" height="4" rx="2" fill="var(--accent)" />
                  <text x="175" y="150" fontFamily="'JetBrains Mono', monospace" fontSize="7" fill="var(--accent)">Uploading 72%</text>
                  <text x="100" y="100" fontFamily="'JetBrains Mono', monospace" fontSize="9" textAnchor="end" fill="var(--subtle-foreground)">Instant Sync</text>
                  <line x1="110" y1="100" x2="155" y2="100" stroke="var(--border-strong)" strokeWidth="1" strokeDasharray="2 2" />
                </svg>
              </div>
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="landing-effect-block">
                  <div className="flex flex-col mb-3 pb-3 border-b border-dashed border-border-subtle">
                    <span className="landing-jb text-[10px] text-subtle-foreground uppercase mb-1">DELIVERY_TIME</span>
                    <span className="landing-display text-2xl text-accent font-bold">당일 전송</span>
                  </div>
                  <div className="landing-jb text-[11px] flex items-center gap-2">
                    <span className="text-subtle-foreground line-through">1~3일 대기</span>
                    <span className="text-accent">→</span>
                    <span className="text-foreground font-bold">촬영 당일 완료</span>
                  </div>
                </div>
              </div>
            </article>
...
function TestimonialsSection() {
  return (
    <section id="testimonials" className="relative z-10 w-full overflow-hidden" style={{ minHeight: "100vh", background: "var(--background)" }}>
      {/* Scanline */}
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 lg:px-24 py-16 sm:py-32 flex flex-col min-h-screen justify-center">
        ...
        <Reveal>
          <div className="flex items-center gap-4 mb-4">
            <span className="landing-mono text-[10px] tracking-[0.2em] text-accent border border-accent/30 px-2 py-1 uppercase">
              USER_TESTIMONIALS
            </span>
            <div className="h-[1px] flex-1 bg-border-subtle" />
            <span className="landing-mono text-[10px] text-disabled-foreground hidden sm:inline">n=2 · VERIFIED</span>
          </div>
          <h2 className="landing-display text-3xl sm:text-4xl lg:text-6xl font-black uppercase leading-tight mb-6 landing-break">
            실제로 써보신<br />
            <span className="text-accent">분들의 이야기</span>
          </h2>
          <p className="landing-mono text-[11px] text-subtle-foreground mb-24">FIELD_REPORT :: REAL_WORKFLOW_FEEDBACK</p>
        </Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {TESTIMONIALS.map((t, i) => (
            <Reveal key={t.id} delayMs={i * 120}>
              <div className="relative border border-border-subtle bg-surface p-8 hover:border-accent/50 transition-colors duration-300">
                {/* ID badge */}
                <div className="absolute top-0 left-0 landing-mono text-[9px] text-accent border border-accent/20 px-2 py-1 -translate-y-1/2 ml-6 bg-background">
                  {t.id}
                </div>

                {/* Quote */}
                <div className="landing-mono text-accent text-xl mb-4 leading-none">&gt;&gt;</div>
                <blockquote className="text-base lg:text-lg text-muted-foreground leading-relaxed mb-8 landing-break italic">
                  &ldquo;{t.quote}&rdquo;
                </blockquote>
                ...
                <div className="flex items-end justify-between border-t border-border-subtle pt-6">
                  <div>
                    ...
                    <p className="landing-mono text-[10px] text-subtle-foreground mt-1">{t.role}</p>
                    <p className="landing-mono text-[10px] text-disabled-foreground mt-0.5">{t.tag}</p>
                  </div>
                  <div className="text-right">
                    <p className="landing-display text-3xl font-black text-accent">{t.stat}</p>
                    <p className="landing-mono text-[9px] text-disabled-foreground mt-1">{t.statLabel}</p>
                  </div>
                </div>
              </div>
            </Reveal>
        ...
        <div className="flex items-center justify-end gap-6 mt-20">
          <div className="flex flex-col items-end landing-mono text-[9px] text-disabled-foreground uppercase">
...
/** 무료 체험 vs 클로즈드 베타 한도 비교 — 숫자는 항상 서버에서 SSR된 app_settings 값만 사용(하드코딩 금지) */
function PlanComparisonCards({
  generalMaxProjects,
  generalMaxPhotosPerProject,
  betaMaxProjectsTotal,
  betaMaxPhotosPerProject,
}: PlanLimits) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto mb-10 text-left">
      <div className="border border-border-subtle bg-surface rounded-xl p-6 flex flex-col gap-3">
        <span className="landing-mono text-[10px] tracking-[0.2em] text-subtle-foreground uppercase">누구나 바로 시작</span>
        <h3 className="landing-display text-lg font-bold">무료 체험</h3>
        <ul className="text-sm text-muted-foreground space-y-1.5 flex-1">
          <li>프로젝트 {generalMaxProjects}개</li>
          <li>프로젝트당 사진 최대 {generalMaxPhotosPerProject}장</li>
        </ul>
      </div>
      <div className="border border-accent/40 bg-accent/5 rounded-xl p-6 flex flex-col gap-3">
        <span className="landing-mono text-[10px] tracking-[0.2em] text-accent uppercase">승인 필요</span>
        <h3 className="landing-display text-lg font-bold">클로즈드 베타</h3>
        <ul className="text-sm text-muted-foreground space-y-1.5 flex-1">
          <li>프로젝트 {betaMaxProjectsTotal}개</li>
          <li>프로젝트당 사진 최대 {betaMaxPhotosPerProject}장</li>
    ...
    <section className="relative z-10 w-full overflow-hidden" style={{ background: "var(--background)", minHeight: "60vh" }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 sm:px-12 py-20 sm:py-40 min-h-[60vh]">
        <Reveal>
          ...
          <h2 className="landing-display text-3xl sm:text-4xl lg:text-5xl font-black uppercase leading-tight mb-10 landing-break">
            다음 촬영부터<br /><span className="text-accent">바로 써보세요</span>
          </h2>
          <PlanComparisonCards {...limits} />
          <button
            type="button"
            onClick={onAuthOpen}
  ...
  return (
    <div className="landing-root">
      ...
      <main>
        ...
        <ServicesSection />
        <TestimonialsSection />
        <CTASection onAuthOpen={handleCta} isLoggedIn={isLoggedIn} limits={limits} />
      </main>
      ...
      <footer className="landing-footer relative z-10 border-t border-border-subtle py-8 bg-background">
        <div className="max-w-[1440px] mx-auto px-6 sm:px-12 flex items-center justify-between">
          ...
          <p className="landing-mono text-[10px] text-disabled-foreground">© {new Date().getFullYear()} A CUT</p>
        </div>
      </footer>
